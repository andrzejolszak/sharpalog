...
namespace ProjectionalBlazorMonaco
{
    public static class Tutorial
    {
        ...
        {
            (n, e) => n.AddChild(new ReadOnlyTextNode("1. Read-only nodes:") { Style = Ast2.Styles.UnderlineStyle })
                .AddChild(ReadOnlyTextNode.NewLine())
                .AddChild(new ReadOnlyTextNode("This is a ReadOnlyTextNode, this text cannot be edited."))
                .AddChild(ReadOnlyTextNode.NewLine()),
            (n, e) => n.AddChild(new ReadOnlyTextNode("2. Editable nodes:") { Style = Ast2.Styles.UnderlineStyle })
                .AddChild(ReadOnlyTextNode.NewLine())
            ...
            (n, e) =>
            {
                ...
                n.AddChild(new ReadOnlyTextNode("3. Synchronized editable nodes:") { Style = Ast2.Styles.UnderlineStyle })
                .AddChild(ReadOnlyTextNode.NewLine())
            ...
            (n, e) => {
                ...
                n.AddChild(new ReadOnlyTextNode("4. Hole nodes:") { Style = Ast2.Styles.UnderlineStyle })
                .AddChild(ReadOnlyTextNode.NewLine())
            ...
            (n, e) => {
                n.AddChild(new ReadOnlyTextNode("5. Reference nodes:") { Style = Ast2.Styles.UnderlineStyle })
                .AddChild(ReadOnlyTextNode.NewLine())
            ...
            (n, e) => {
                n.AddChild(new ReadOnlyTextNode("6. Enum nodes:") { Style = Ast2.Styles.UnderlineStyle })
                .AddChild(ReadOnlyTextNode.NewLine())
            ...
            (n, e) => {
                n.AddChild(new ReadOnlyTextNode("7. Toggle nodes:") { Style = Ast2.Styles.UnderlineStyle })
                .AddChild(ReadOnlyTextNode.NewLine())
                .AddChild(new ToggleNode())
                .AddChild(new ReadOnlyTextNode(" is a ToggleNode that can be edited with mouse or spacebar"));
            },
            (n, e) => {
                n.AddChild(new ReadOnlyTextNode("8. List nodes:") { Style = Ast2.Styles.UnderlineStyle })
                .AddChild(ReadOnlyTextNode.NewLine())
